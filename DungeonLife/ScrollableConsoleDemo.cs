...
{
    public class ScrollableConsoleDemo : SadConsole.Console
    {
        ...
        public ScrollableConsoleDemo(int width, int height, int bufferHeight) : base(width - 1, height, width - 1, bufferHeight)
        {
